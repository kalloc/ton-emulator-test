...
export type CompilationTargets = {
    [name: string]: string;
};
...
const COMMON_TARGETS: CompilationTargets = {
    "stdlib.fc": "func/common/stdlib.fc",
    "opcodes.fc": "func/common/opcodes.fc",
    "utils.fc": "func/common/utils.fc",
    "params.fc": "func/common/params.fc",
};

export const createContract = async (additions_targets: CompilationTargets): Promise<ContractsData> => {
